...
/**
 * Convert the given argument into a Date object.
 * @param   {*} val  value to convert to a Date.
...
const selectorParserFactory = (xmlNode, selectXPath) =>
  function selectorParser(selectors, multiFields) {
    return _.reduce(selectors, (result, selector, selectorKey) => {
